...
public class MyAdapter extends ListHorizontalScrollViewAdapter implements AdapterDefault{

	public MyAdapter(View[] itemViews, View[] innerItemViews, Context context,
			ListView listView, String alignMode, String cSrollMode) {
		super(itemViews, innerItemViews, context, listView, alignMode, cSrollMode);
